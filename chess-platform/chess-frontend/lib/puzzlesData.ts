...
export interface ChessPuzzle {
  ...
  categoryName: string;
  difficulty:
    "Dễ (1000-1300)" | "Trung Bình (1300-1600)" | "Khó (1600-1900)" | "Cao Thủ (1900+)";
  rating: number;
  fen: string;
...
export const CHESS_PUZZLES: ChessPuzzle[] = [
  {
    ...
    playerColor: "white",
    description:
      "Trắng đi trước. Xe Đen đang canh giữ hàng ngang số 8. Hãy tìm cách phá vỡ phòng tuyến!",
    hint: "Xe Đen đang phải gánh trách nhiệm bảo vệ hàng 8. Hãy lôi kéo Xe Đen rời bỏ vị trí!",
    explanation:
      "1. Qe8+! Thí Hậu bắt buộc Xe Đen phải ăn 1... Rxe8. Sau đó 2. Rxe8# Chiếu bí kinh điển hàng cuối (Back-rank Mate).",
    solutionSteps: [
      {
        from: "b3",
        to: "e8",
  ...
  },
  {
    ...
    playerColor: "white",
    description:
      "Hậu Đen đứng ở vị trí e5 hớ hênh. Mã Trắng có thể tấn công đôi Vua và Hậu hoặc bắt không quân?",
    hint: "Hãy nhìn vào ô c3 hoặc đường đi của Mã Trắng để chĩa đôi!",
    explanation:
      "1. Nc3 hoặc tốt hơn là đòn bắt đôi bất ngờ. Mã Trắng bảo vệ vị trí hoặc nhảy chiếu đôi.",
    solutionSteps: [
      {
        from: "e4",
        to: "c3",
  ...
  },
  {
    ...
    explanation:
      "1. Rxd8# Xe Trắng đâm thẳng xuống d8 chiếu bí vì hàng tốt 7 chặn đứng Vua Đen.",
    solutionSteps: [
      {
        from: "d1",
        to: "d8",
  ...
  },
  {
    ...
    playerColor: "white",
    description:
      "Hậu Đen ở a5 nằm cùng đường chéo với Tượng d3 và Xe c1. Tạo đòn chiếu mở!",
    ...
    solutionSteps: [
      {
        ...
        opponentSan: "Qxb4",
        opponentFenAfter:
          "r1b1kb1r/pp3ppp/2n1pn2/2pp4/1q1P1B2/2PBPN2/P4PPP/RN1QK2R w KQkq - 0 9",
  ...
  },
  {
    ...
    playerColor: "white",
    description:
      "Xe Đen vừa chiếu ở h1 nhưng Tượng Trắng ở c4 có thể chiếu lại Vua Đen và bắt Xe đằng sau.",
    hint: "Hãy di chuyển Vua né chiếu để Tượng c4 lộ đòn bắt Xe!",
    explanation:
      "1. Kd2! hoặc 1. Ke2! bảo vệ an toàn cho Vua, chuẩn bị bắt gọn quân đối phương.",
    solutionSteps: [
      {
        from: "e1",
        to: "e2",
  ...
  },
  {
    ...
    playerColor: "white",
    description:
      "Hậu Trắng và Tượng c4 cùng nhắm thẳng vào ô f7 phòng thủ yếu nhất của Đen!",
    hint: "Ô f7 chỉ có Vua Đen bảo vệ. Hãy cho Hậu ăn thẳng vào f7!",
    explanation:
      "1. Qxf7# Chiếu bí Scholar's Mate kinh điển! Vua Đen không thể ăn Hậu vì có Tượng c4 bảo kê.",
    solutionSteps: [
      {
        from: "f3",
        to: "f7",
