...
export const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    // Hero Section
    "hero.badge": "⚡ NỀN TẢNG CỜ VUA THẾ HỆ MỚI • GOLANG & RUST POWERED",
    "hero.title": "Chơi Cờ Vua Đỉnh Cao Trực Tuyến",
    "hero.subtitle":
      "Trải nghiệm cờ vua mượt mà với bàn cờ 3D chân thực, thi đấu thời gian thực qua Gateway Golang siêu nhẹ, huấn luyện cùng AI Stockfish và phân tích ván đấu chính xác bằng Rust Engine.",
    ...
    "hero.statPrecision": "Tốc độ phân tích Rust",
    "hero.statPrecisionVal": "10 µs",
    ...
    // Footer
    "footer.desc":
      "Nền tảng cờ vua hiện đại hàng đầu với đồ họa tinh tế, cổng WebSocket Golang và động cơ phân tích Rust tốc độ microsecond.",
  ...
  en: {
    ...
    // Hero Section
    "hero.badge": "⚡ NEXT-GEN CHESS PLATFORM • POWERED BY GOLANG & RUST",
    "hero.title": "Play World-Class Chess Online",
    "hero.subtitle":
      "Experience seamless chess with realistic 3D boards, high-performance real-time multiplayer via Golang Gateway, Stockfish AI training, and sub-millisecond game analysis powered by Rust.",
    ...
    "hero.statPrecision": "Rust Engine Speed",
    "hero.statPrecisionVal": "10 µs",
    ...
    // Footer
    "footer.desc":
      "Premier chess platform featuring elegant aesthetics, low-latency Golang WebSocket gateway, and microsecond Rust analysis engine.",
