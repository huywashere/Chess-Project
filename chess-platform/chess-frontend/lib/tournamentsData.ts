...
export const CHESS_TOURNAMENTS: ChessTournament[] = [
  {
    ...
    maxPlayers: 256,
    description:
      "Giải đấu chớp cuồng nhiệt hàng ngày. Hệ thống ghép cặp liên tục, tích lũy chuỗi thắng lửa (Streak Fire) để bứt phá bảng vàng.",
    badge: "TRỰC TIẾP",
    colorScheme:
      "linear-gradient(135deg, rgba(239, 68, 68, 0.2), rgba(212, 174, 26, 0.15))",
    standings: [
      {
        rank: 1,
        name: "LeQuangLiem_VN",
  ...
  },
  {
    ...
    maxPlayers: 512,
    description:
      "Giải đấu danh giá nhất tuần quy tụ các Kiện Tướng hàng đầu quốc gia và quốc tế. Thi đấu 7 ván tính điểm hệ số Buchholz chuẩn FIDE.",
    badge: "SẮP BẮT ĐẦU",
    colorScheme:
  ...
  },
  {
    ...
    maxPlayers: 128,
    description:
      "Sân chơi hoàn hảo cho các bạn mới học cờ hoặc đang ở mức ELO dưới 1500. Thử sức cạnh tranh công bằng, học hỏi kinh nghiệm thực chiến.",
    badge: "TÂN THỦ",
    colorScheme:
      "linear-gradient(135deg, rgba(129, 182, 76, 0.2), rgba(212, 174, 26, 0.15))",
    standings: [],
    pairings: [],
  },
  {
    ...
    maxPlayers: 256,
    description:
      "Giải đấu mùa thu quy tụ hơn 256 kỳ thủ tranh tài nảy lửa qua 2 giờ thi đấu liên tục.",
    badge: "ĐÃ KẾT THÚC",
