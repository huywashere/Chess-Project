...
public class JwtService {
    ...
    @Value("${app.jwt.secret:change-this-secret-key-in-production-min-256-bits-length-guaranteed-chessmaster}")
    ...
    public String generateTokenForUsername(String username, Map<String, Object> claims) {
